 ...
 *
 * `UsersService` is exported: Session 19's bulk upload builds on it, and Session
 * 20's bindings API has to resolve a user and check they belong to the caller's
 * client before granting them anything (Doc 02 §6).
 */
